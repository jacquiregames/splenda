            ...
            <div className="how-to-play-modal" onClick={e => e.stopPropagation()}>
                ...
                <div className="how-to-play-content">
                    ...
                    <div className="how-to-play-text">
                        <h3>Objective</h3>
                        <p>The game ends at the end of the round when a player reaches <strong>15 points</strong>. The player with the most points (and fewest development cards in case of a tie) wins.</p>
                        ...
                        <ul>
                            ...
                            <li><strong>Reserve 1 card:</strong> Take a card from the board or draw from a deck blindly. You also receive 1 Gold token (if available). You may hold a maximum of 3 reserved cards.</li>
                        ...
                        <h3>Tokens & Gold</h3>
                        <ul>
                            <li><strong>Token Limit:</strong> You may never have more than 10 tokens at the end of your turn. If you do, you must discard the excess.</li>
                            <li><strong>Gold Tokens:</strong> They can replace ANY color token when buying a card.</li>
                        </ul>

                        <h3>Nobles</h3>
                        <ul>
                            <li>At the end of your turn, if you have accumulated enough permanent card bonuses (discounts) to match a Noble's requirements, you automatically receive that Noble.</li>
                    ...
                    <div className="how-to-play-image-container">
                        ...
                        <div className="how-to-play-cards-column">
                            <img 
                                src="/images/new/row4/20006.png" 
                                alt="Example Noble" 
                                className="how-to-play-card-img noble-example" 
                            />
                            <img 
                                src="/images/new/row2/057.png" 
                                alt="Example Card" 
                                className="how-to-play-card-img card-example" 
                            />
                        </div> 
                    </div>
                </div>
